    ...
    <div className="bg-white dark:bg-[#141414] border-b border-gray-200 dark:border-[#2a2a2a] sticky top-14 z-40 transition-colors duration-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-2 py-2">
          ...
          {/* Selectors — scroll horizontally on mobile */}
          ...
          {/* Actions — always pinned to the right, never hidden */}
          <div className="flex items-center gap-1.5 flex-shrink-0">

            {/* Audio */}
            <button
              aria-label="Audio"
              className="p-1.5 rounded-full border border-gray-200 dark:border-[#333333] text-gray-500 dark:text-[#888888] hover:border-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors"
            >
            ...
            {/* Font size — tap to cycle S → M → L → XL → XXL */}
            <button
              aria-label="Font size"
              onClick={cycleFont}
              className="flex items-center gap-0.5 px-3 py-1.5 rounded-full border border-gray-200 dark:border-[#333333] text-gray-500 dark:text-[#888888] hover:border-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors select-none"
            >
