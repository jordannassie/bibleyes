    ...
    <div className="bg-white dark:bg-[#141414] border-b border-gray-200 dark:border-[#2a2a2a] sticky top-14 z-40 transition-colors duration-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-2 py-2 overflow-x-auto scrollbar-none">
          ...
          {/* Parallel */}
          <button className="flex-shrink-0 hidden sm:flex items-center gap-1.5 rounded-full border border-gray-200 dark:border-[#333333] px-3 py-1.5 text-xs font-medium text-gray-500 dark:text-[#888888] hover:border-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors">
          ...
          {/* Audio */}
          <button aria-label="Audio" className="flex-shrink-0 p-1.5 rounded-full border border-gray-200 dark:border-[#333333] text-gray-500 dark:text-[#888888] hover:border-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors">
          ...
          {/* Font size */}
          <button aria-label="Font size" className="flex-shrink-0 px-3 py-1.5 rounded-full border border-gray-200 dark:border-[#333333] text-sm font-semibold text-gray-500 dark:text-[#888888] hover:border-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors">
            AA
          </button>
        </div>
      </div>
